...
function GMGenie.onLoad()
    ...
    if GMGenie_InitPlayerClassResolver then
        GMGenie_InitPlayerClassResolver();
    end
	...
	UIDropDownMenu_Initialize(GMGenie_Hud_DropdownbuttonsTwo, GMGenie.Hud.loadDropdown, "MENU");

    GMGenie.optionsOnLoad();
    GMGenie.Tickets.optionsOnLoad();
    GMGenie.Notifications.optionsOnLoad();
    ...
    GMGenie.showGMMessage("GMGenie 0.7.3.49 (safe class colors for GM system links), based on GMGenie by Chocochaos ((c) 2011-2014).");
end
